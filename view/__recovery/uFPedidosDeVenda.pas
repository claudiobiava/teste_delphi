...
type
  ...
  private
    ...
    goItemPedidoSendoAlterado: TItemPedido;
...
begin
  ...
  begin
    ...
    oPedidosDeVendaModel := oPedidosDeVendaDAO.getPedidosDeVendasByNumeroPedido(StrToIntDef(sNumeroPedido, -1));
